				...
				<div class="col-lg-12 my-2" style="width: 100%">
					<ol class="breadcrumb dark-link m-0 small justify-content-center"
						style="text-align: center">
						 <li class="breadcrumb-item"><a class="text-nowrap" href="5_hyangsta_all.do" style="color: #9397AD;"><i
                                         class="bi bi-home"></i>ALL</a></li>
                         <li class="breadcrumb-item"><a class="hyFwBtn text-nowrap" href="5_hyangsta_followPList.do?user_id=${sessionScope.user_id}" style="color: #9397AD;"><i
                                     class="bi bi-home"></i>FOLLOWING</a></li>
                         <li class="breadcrumb-item"><a class="hyMyBtn text-nowrap" href="5_hyangsta_userlist.do?user_id=${sessionScope.user_id}" style="color: #9397AD;"><i
                                         class="bi bi-home"></i>MY</a></li>
					</ol>
				</div>
			</div>
		</div>
